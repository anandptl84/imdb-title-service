...
public class TitleEpisodeConfig {
	...
	public ItemReader<TitleEpisodeRow> titleEpisodeReader() {
		FlatFileItemReader<TitleEpisodeRow> csvFileReader = new FlatFileItemReader<>();
	...
	public LineMapper<TitleEpisodeRow> titleEpisodeRowMapper(){
		DefaultLineMapper<TitleEpisodeRow> titleEpisodeRowMapper = new DefaultLineMapper<>();
	...
	public LineTokenizer titleEpisodeLineTokenizer() {
		DelimitedLineTokenizer titleEpisodeTokenizer = new DelimitedLineTokenizer();
	...
	public ItemWriter<TitleEpisodeRow> compositeTitleEpisodeRowWriter() {
		CompositeItemWriter<TitleEpisodeRow> compositeWriter = new CompositeItemWriter<>();
