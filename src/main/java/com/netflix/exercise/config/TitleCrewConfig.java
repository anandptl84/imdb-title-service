...
public class TitleCrewConfig {
	...
	ItemReader<TitleCrewRow> titleCrewReader() {
		final FlatFileItemReader<TitleCrewRow> csvFileReader = new FlatFileItemReader<>();
	...
	public LineMapper<TitleCrewRow> titleCrewLineMapper() {
		final DefaultLineMapper<TitleCrewRow> titleCrewRowMapper = new DefaultLineMapper<>();
	...
	public LineTokenizer titleCrewLineTokenizer() {
		final DelimitedLineTokenizer titleCrewLineTokenizer = new DelimitedLineTokenizer();
	...
	public ItemWriter<TitleCrewRow> compositeTitleCrewRowWriter() {
		final CompositeItemWriter<TitleCrewRow> compositeWriter = new CompositeItemWriter<>();
